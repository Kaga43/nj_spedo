...
function setHeadlights(state) {
    light1.classList.toggle("active", state > 0);
    light2.classList.toggle("active", state === 2);
}

function setLeftIndicator(state) { leftSein.classList.toggle("active", state); }

function setRightIndicator(state) { rightSein.classList.toggle("active", state); }
